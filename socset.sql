...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Ноя 02 2017 г., 13:35
...
(1, 'first', 'qwe', '2017-10-24 06:51:56', '2017-10-24 06:51:56', NULL),
(2, 'second', 'rty', '2017-11-02 07:34:39', '2017-11-02 07:34:39', NULL),
(3, 'third', 'asd', '2017-11-02 07:34:49', '2017-11-02 07:34:49', NULL),
(4, 'forth', 'fgh', '2017-11-02 07:35:03', '2017-11-02 07:35:03', NULL),
(5, 'fifth', 'fgh', '2017-11-02 07:35:21', '2017-11-02 07:35:21', NULL),
(6, 'sixth', 'zxc', '2017-11-02 07:35:31', '2017-11-02 07:35:31', NULL);

-- --------------------------------------------------------

--
-- Структура таблицы `crudname`
--

CREATE TABLE `crudname` (
  `id` int(10) UNSIGNED NOT NULL,
  `FieldDBname` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(4, 0, 1, 'fa-database', 'Products', 'Products', NULL, '2017-10-24 07:40:25', '2017-10-24 07:40:25');
...
(10, '2017_10_19_114944_create_catalog_table', 2);
...
--
-- Индексы таблицы `crudname`
--
ALTER TABLE `crudname`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT для таблицы `crudname`
--
ALTER TABLE `crudname`
